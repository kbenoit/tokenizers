...
# Given n and k, generate the positions of valid indexes of words comprising
# the skip n-gram. In other words, there will be n integers in each element of
# the list, and the distance between those integers will be a maximum of k.
